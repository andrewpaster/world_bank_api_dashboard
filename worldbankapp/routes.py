...
def index():
	...
	if (request.method == 'POST'):
		...
		figures = return_figures(requests.form)
		...
		country_codes = [['Canada','CAN'],['United States','USA'],['Brazil','BRA'],['France','FRA'],['India','IND'],['Italy','ITA'],['Germany','DEU'],['United Kingdom','GBR'],['China','CHN'],['Japan','JPA']]
